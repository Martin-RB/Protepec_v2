...
define(["require", "exports", "../ScreenDynamicCommon/ViewAble", "../NavigationCommon/LoadOriginType"], function (require, exports, ViewAble_1, LoadOriginType_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BasePresenter = /** @class */ (function (_super) {
        __extends(BasePresenter, _super);
        function BasePresenter() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        BasePresenter.prototype.SetData = function (type, data) {
            if (type == LoadOriginType_1.LoadOriginType.FROM_FATHER) {
                this.fatherData = data;
            }
            else if (type == LoadOriginType_1.LoadOriginType.FROM_SON) {
                this.sonData = data;
            }
        };
        ...
        Object.defineProperty(BasePresenter.prototype, "navigation", {
            get: function () {
