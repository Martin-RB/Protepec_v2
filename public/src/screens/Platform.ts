...
import { RegisterLorryPresenter } from "./RegisterLorry";
import { WorkHeadsPresenter } from "./WorkHeads";
    ...
    OnCreate(){
        ...
        this.View.GoToSection = (section:string) => {
            switch(section){
                ...
                break;
                case "registerLorry":
                    this.innerNav.PushScreen(RegisterLorryPresenter);
                break;
                case "workHeads":
                    this.innerNav.PushScreen(WorkHeadsPresenter);
                break;
                case "feedCorrals":
                    this.innerNav.PushScreen(HomePresenter);
                break;
